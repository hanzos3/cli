...
// createCertsDir - create Hanzo S3 Client certs folder
...
// createCAsDir - create Hanzo S3 Client CAs folder
...
// loadRootCAs fetches CA files provided in Hanzo S3 config and adds them to globalRootCAs
